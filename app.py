...
def main():
    ...
    st.title('Telecom Sector Customer Churn Prediction App')
    ...
    \n (I have created this project as one of my MBA Project)
    """)
	...
	"Choose a mode for prediction : Online or Batch", ("Online", "Batch"))
